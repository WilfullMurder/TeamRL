...
public class DataGenerator {
     ...
     */
    public ArrayList<UserInfoComponent> generateUserData(int count)
    {
        ArrayList<UserInfoComponent> userList = new ArrayList<>();
        ...
        for(int i=0; i<count; i++)
        {
            ...
            UserInfoComponent u = new UserInfoComponent(surname,forename,ub,email,password,generateDOB(), startY, endY);
