...
/**obvious solution is to parse the first char of forename and surname on all users**/
public class BeanComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
        ...
        //nested ternary operator just to be fancy
        ...
        //we can just copy/paste and reverse the negative & objects for reverse order btw
