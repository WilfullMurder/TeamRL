...
import com.example.teamrlnew.components.*;
...
public class RegisterBgSolidController {
    ...
    public void initialize(){
        window.setPrefWidth(ScreenComponent.SCREEN_WIDTH);
        window.setPrefHeight(ScreenComponent.SCREEN_HEIGHT);
        registerBGImageView.setFitHeight(ScreenComponent.SCREEN_HEIGHT);
        registerBGImageView.setFitWidth(ScreenComponent.SCREEN_WIDTH);
    ...
    public void onLoginRedirectButtonClick(ActionEvent event) {
